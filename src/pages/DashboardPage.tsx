...
const benefits: Benefit[] = [
  ...
  {
    name: 'Golf Rounds at 50%',
    pool: 'Golf',
    original: '20 rounds',
    remaining: '20 rounds',
    expires: 'No date listed',
  },
  {
    name: 'Unlimited Golf Bonus Nights',
    pool: 'Golf',
    original: '8 nights',
    remaining: '8 nights',
    expires: 'Mar 29, 2031',
          ...
          {benefits.map((benefit) => (
            <article className="benefit-card" key={benefit.name}>
              <div className="benefit-title-row">
                <h4>{benefit.name}</h4>
                <span className={`pool-tag ${benefit.pool.toLowerCase()}`}>
                  {benefit.pool}
                </span>
              </div>
              ...
              <dl>
                <div>
                  <dt>Remaining</dt>
                  <dd>{benefit.remaining}</dd>
                </div>
                <div>
                  <dt>Original</dt>
                  <dd>{benefit.original}</dd>
                </div>
                <div>
                  <dt>Expires</dt>
                  <dd>{benefit.expires}</dd>
                </div>
              </dl>
            </article>
          ))}
